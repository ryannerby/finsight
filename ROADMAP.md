...
- **Ryan (FE driver)**:
    ...
    - [x]  Hook in Clerk login (just local dev mode)
- **Daniel (BE driver)**:
...
**Daniel (FE driver)** — yes, Daniel does React today

**Ryan (BE driver)** — Ryan does backend today
...
**Ryan (BE driver)** — Ryan does backend

**Daniel (FE driver)** — Daniel does frontend
